...
def random_failure_response():
    responses = ["Oops! That's not correct.", "Try again!", "Incorrect guess!", "Oh No! That letter is not in the word.", "Keep trying!", "Not quite right!"]
...
def hangman():
    ...
    while True:
        ...
        if guess not in word:
            attempts -= 1
            print(f"{random_failure_response()}")
